...
FROM Pixar.Movies AS M
INNER JOIN Pixar.BoxOffice AS B
ON international_sales > B.domestic_sales;
...
ORDER BY T.name DESC;
    ...
    -- todos os dados dos filmes, mesmo os que não estão em cartaz e, adicionalmente,
    -- os dados dos cinemas que possuem estes filmes em cartaz. Retorne os nomes dos
...
-- INNER JOIN , que retornem os títulos dos filmes que possuem avaliação maior que 7.5.
...
-- Exercício 8: Utilizando o EXISTS , selecione o nome e localização dos cinemas que
