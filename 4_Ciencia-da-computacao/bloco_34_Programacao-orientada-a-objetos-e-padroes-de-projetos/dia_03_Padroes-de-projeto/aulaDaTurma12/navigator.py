...
class BikeStrategy(NavigationStrategy):
    @classmethod
    def build_route(cls, departure, arrival):
        print(f"Rota de bicicleta saindo de {departure} paara {arrival}")


class BusStrategy(NavigationStrategy):
    @classmethod
    def build_route(cls, departure, arrival):
        print(f"Rota de ônibus saindo de {departure} paara {arrival}")


class CarStrategy(NavigationStrategy):
    @classmethod
    def build_route(cls, departure, arrival):
        print(f"Rota de carro saindo de {departure} paara {arrival}")
