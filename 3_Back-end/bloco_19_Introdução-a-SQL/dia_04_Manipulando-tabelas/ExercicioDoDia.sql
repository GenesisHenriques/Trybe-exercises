...
VALUES ('Procurando Nemo', 'Jonh Lasseter', 2003, 107),
	   ('Os incriveis', 'Brand Bird', 2004, 116),
       ('WALL_E', 'Pete Docter', 2008, 104);
       
-- Exercício 2 : Procurando Nemo foi aclamado pela crítica!
-- Foi classificado em 6.8, fez 450 milhões no mercado interno 
...
-- Exercício 4 : O título do filme "Ratatouille" esta escrito de
-- forma incorreta na tabela Movies , além disso, o filme foi lançado
-- em 2007 e não em 2010. Corrija esses dados utilizando o UPDATE .
